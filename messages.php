    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Messages</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row bg-gray">
            <div class="container">
                    <div class="row mb-5">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Your Messages</h2>
							<?php 
								if(isset($_GET['msg']))	
								echo $_GET['msg'];	
					...
					<table class="items-list col-lg-12" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-primary">
								...
								<th class="text-white font-weight-bolder">Messages</th>
                        ...
                        <tbody>
							...
							<?php 
							$uid=$_SESSION['uid'];
							$query=mysqli_query($con,"SELECT * FROM `messages` WHERE uid='$uid'");
