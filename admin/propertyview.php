                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="data:<?php echo $row['10']; ?>;base64,<?php echo base64_encode($row['11']); ?>" alt="Portfolio Image" height="70px" width="70px"></td>
                                                    <td><img src="data:<?php echo $row['10']; ?>;base64,<?php echo base64_encode($row['12']); ?>" alt="Portfolio Image" height="70px" width="70px"></td>
